...
export default function DashboardLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Content', href: '/dashboard/content', icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' },
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className={`${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-30 w-64 transition duration-300 ease-in-out transform bg-white shadow-lg md:translate-x-0`}>
